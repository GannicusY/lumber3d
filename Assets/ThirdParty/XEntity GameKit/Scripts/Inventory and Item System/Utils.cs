        ...
        */
        ...
        public static void InstantiateItemCollector(Item item, Vector3 position) 
        {
            ...
            if (InteractionSettings.Current.itemCollectorMode == ItemCollectorMode.Static)
            {
                ...
                float maxSizeComponent = MaxVec3Component(GetObjectSize(instance));
        ...
        public static Vector3 GetObjectSize(GameObject instance)
        {
            if(instance.TryGetComponent<MeshRenderer>(out var meshRenderer))
            {
        ...
        public static void HighlightObject(GameObject obj) 
        {
            ...
            {
                meshRenderer.material.color = InteractionSettings.Current.highlightColor;
            }
            else if(obj.TryGetComponent<SpriteRenderer>(out var spriteRender))
            {
                spriteRender.color = InteractionSettings.Current.highlightColor;
            }
        }
